...
public class StudentEndpoint {
	...
	@GetMapping
	public ResponseEntity<?> listAll(Pageable pageable) { // Pageable do spring para poder paginar a lista
															// ...students?page=0sice=10 (para ordenar é só escolher o
															// campo.asc ou campo.desc ex: sort=name.asc)
	...
	@PostMapping
	public ResponseEntity<?> save(@Valid @RequestBody Student student) { // O Valid verifica se o que esta vindo no body
																			// é valido com o do modelo no caso o nome
